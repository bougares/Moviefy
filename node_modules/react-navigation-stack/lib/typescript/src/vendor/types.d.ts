import type * as React from 'react-navigation-stack/lib/typescript/src/vendor/node_modules/react';
import type { Animated, StyleProp, TextStyle, ViewStyle, LayoutChangeEvent } from 'react-native';
import type { EdgeInsets } from 'react-navigation-stack/lib/typescript/src/vendor/node_modules/react-native-safe-area-context';
import type { NavigationRoute, NavigationState, NavigationScreenProp, NavigationProp, NavigationParams, NavigationNavigateAction, NavigationAction, NavigationEventCallback, NavigationEventSubscription, NavigationDescriptor } from 'react-navigation-stack/lib/typescript/src/vendor/node_modules/react-navigation';
